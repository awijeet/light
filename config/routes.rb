Light::Application.routes.draw do  
  ...
  match "/likes/:id" => "user#likes"
  match "/friends/:id" => "user#friends"
  match '/index', :to => "home#index"
  match '/about_us', :to => "home#about_us"
  match '/privacy_policy', :to => "home#privacy_policy"
  match '/render_record/:id', :to => "home#render_record"
  match '/login', :to => "home#login"
  match '/logout', :to => "home#logout"
  match '/search', :to => "home#search"
  match '/show_content/:id', :to => "home#show_content"
  #get "home/index"
  #get "home/about_us"
  #get "home/privacy_policy"
  #get "home/render_record/:id" => "home#render_record"
  #get "user/show"
  #get "user/edit"
  #get "user/likes"
  #get "user/friends"
